...
We'll be using the *piracy* data set included in the *Data* subfolder of our *Labs* folder. It contains data for each member of congress and money they received from lobby groups for (money_pro) and against (money_con) anti-piracy legislation. 
